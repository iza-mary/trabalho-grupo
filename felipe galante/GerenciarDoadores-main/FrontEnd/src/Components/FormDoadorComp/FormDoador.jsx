      ...
      <Card className="card-container">
        <Form noValidate validated={validated} onSubmit={(e) => { handleSubmit(e) }}>
          <Row>
            <Col>
              ...
              <Form.Group controlId="nome">
                ...
                <Form.Control isInvalid={!!errors.nome} required value={doador.nome} onChange={(e) => { handleChangeNome(e) }} placeholder="Nome Sobrenome" type="text" name="nome" />
                <Form.Control.Feedback type="invalid">{errors.nome}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="cpf">
                <Form.Label>CPF</Form.Label>
                <Form.Control maxLength={14} onChange={(e) => { handleChangeCpf(e) }} value={doador.cpf} isInvalid={!!errors.cpf} type="text" name="cpf" placeholder="123.456.789-01" />
                <Form.Control.Feedback type="invalid">{errors.cpf}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="telefone">
                <Form.Label>Telefone</Form.Label>
                <Form.Control maxLength={15} onChange={(e) => { handleChangeTelefone(e) }} value={doador.telefone} isInvalid={!!errors.telefone} type="tel" placeholder="(12) 34567-8901"></Form.Control>
                <Form.Control.Feedback type="invalid">{errors.telefone}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="rg">
                <Form.Label>RG (Opcional)</Form.Label>
                <Form.Control onChange={(e) => { handleChangeRg(e) }} isInvalid={!!errors.rg} value={doador.rg} maxLength={12} type="text" placeholder="12.345.678-9" name="rg"></Form.Control>
                <Form.Control.Feedback type="invalid">{errors.rg}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="email">
                <Form.Label>E-mail (Opcional)</Form.Label>
                <Form.Control onChange={(e) => { handleChangeEmail(e) }} isInvalid={errors.email} value={doador.email} type="email" placeholder="exemplo@exemplo.com" name="email"></Form.Control>
            ...
            <Col>
              ...
              <Form.Group controlId="cidade">
                ...
                <Form.Control onChange={(e) => { handleChangeCidade(e) }} value={doador.cidade} placeholder="Cidade (Estado)" name="cidade" type="text"></Form.Control>
              </Form.Group>
              <br />
              <Form.Group controlId="rua">
                <Form.Label>Rua</Form.Label>
                <Form.Control onChange={(e) => { handleChangeRua(e) }} isInvalid={!!errors.rua} value={doador.rua} placeholder="Rua, Bairro" type="text" name="rua"></Form.Control>
                <Form.Control.Feedback type="invalid">{errors.rua}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="numero">
                <Form.Label>Número</Form.Label>
                <Form.Control onChange={(e) => { handleChangeNumero(e) }} value={doador.numero} type="text" placeholder="99" name="numero"></Form.Control>
              </Form.Group>
              <br />
              <Form.Group controlId="cep">
                <Form.Label>CEP</Form.Label>
                <Form.Control isInvalid={!!errors.cep} maxLength={9} onChange={(e) => { handleChangeCep(e) }} value={doador.cep} type="text" name="cep" placeholder="12345-000"></Form.Control>
                <Form.Control.Feedback type="invalid">{errors.cep}</Form.Control.Feedback>
              </Form.Group>
              <br />
              <Form.Group controlId="complemento">
                <Form.Label>Complemento</Form.Label>
                <Form.Control onChange={(e) => { handleChangeComp(e) }} isInvalid={!!errors.complemento} value={doador.complemento} as={"textarea"} placeholder="Andar 5, Ap 21, Bloco 3"></Form.Control>
          ...
          <div className="container-button">
            <Button onClick={() => {limpaForm()}} className="buttons" type="button" variant="secondary">Limpar</Button>
            <Button className="buttons" type="submit" variant="success">Cadastrar Doador</Button>
          </div>
        </Form>
      </Card>
    </div>
